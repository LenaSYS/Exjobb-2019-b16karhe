...
<html ng-app="cartApp"> <!-- Starting AngularJS -->
    ...
    <body>
        ...
        <div ng-controller="cartCtrl"> <!-- Link to the controller. -->
            ...
            <ol>
                <h3>PRIS: {{ getTotal() }} <label ng-if="newProduct">+ {{newProduct.price}} = {{getTotal() + newProduct.price}}   kr</label></h3>
            ...
            <form ng-submit="newProduct = false">
                ...
                <div ng-repeat="product in products | filter:{selectedQuantity:null} | limitTo:5"> <!-- Listing 5 prodcuts outside of the cart by limiting the itteration through "limitTo" -->
                ...
                <button ng-disabled="newProduct == false" ng-click="products[id].selectedQuantity = 1">Add product</button>
            </form>
        </div> 
    </body>
</html>