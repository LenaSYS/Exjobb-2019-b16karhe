    ...
    <body>
        ...
        <div id="cartApp" ng-controller="cartCtrl"> <!-- Link to the controller. -->
            ...
            <form id="outerFlex" ng-submit="newProduct = false">
                ...
                <div class="innerFlex" ng-repeat="product in products | filter:{selectedQuantity:null} | limitTo:3"> <!-- Listing 5 prodcuts outside of the cart by limiting the itteration through "limitTo" -->
