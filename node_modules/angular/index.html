    ...
    <body>
        ...
        <div id="cartApp" ng-controller="cartCtrl"> <!-- Link to the controller. -->
            ...
            <ol>
                ...
                <div id="theCart">
                <li class="lista" ng-repeat="product in products| filter:{selectedQuantity: ''}"> <!-- Listing of items inside products as product. The data is retrived from the model through the controller. -->
                    {{product.stockCode}} -
                    "{{product.description}}" -
                    {{product.price}} kr/st
            ...
            <form id="outerFlex" ng-submit="newProduct = false">
                ...
                <div class="innerFlex" ng-repeat="product in products | filter:{selectedQuantity:null} | limitTo:5"> <!-- Listing 5 prodcuts outside of the cart by limiting the itteration through "limitTo" -->
